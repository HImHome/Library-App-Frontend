  ...
  useEffect(() => {
    const fetchUserCheckedOutBook = async () => {
      if (authState && authState.isAuthenticated) {
        ...
        const bookCheckedOutResponeJson = await bookCheckedOut.json();
        setIsCheckedOut(bookCheckedOutResponeJson);
      }
    ...
    <div>
      <div className="container d-none d-lg-block">
        <div className="row mt-5">
          <div className="col-sm-2 col-md2">
            {book?.img ? (
        ...
        <hr />
        <LatestReviews reviews={reviews} book={book?.id} mobile={false} />
      </div>
      <div className="container d-lg-none mt-5">
        ...
        />
        <hr />
        <LatestReviews reviews={reviews} book={book?.id} mobile={true} />
      </div>
    </div>
  );
};
